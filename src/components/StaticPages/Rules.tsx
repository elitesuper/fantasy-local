...
const Rules = () => {
    return (
        <div className={styles.columns}>
            ...
            <div className={classNames("box", styles.boxCustom)}>
                <div className="boxTitle">Title #10</div>
                <div className={styles.rule}>
            ...
            <div className={classNames("box", styles.boxCustom)}>
                <div className="boxTitle">Title #11</div>
                <div className={styles.rule}>
            ...
            <div className={classNames("box", styles.boxCustom)}>
                <div className="boxTitle">Title #12</div>
                <div className={styles.rule}>
            ...
            <div className={classNames("box", styles.boxCustom)}>
                <div className="boxTitle">Title #13</div>
                <div className={styles.rule}>
            ...
            <div className={classNames("box", styles.boxCustom)}>
                <div className="boxTitle">Title #14</div>
                <div className={styles.rule}>
            ...
            <div className={classNames("box", styles.boxCustom)}>
                <div className="boxTitle">Title #15</div>
                <div className={styles.rule}>
            ...
            <div className={classNames("box", styles.boxCustom)}>
                <div className="boxTitle">Title #16</div>
                <div className={styles.rule}>
