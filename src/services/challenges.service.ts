...
export class ChallengesService {
    ...
    async myChallenges(reqBody: { userId: String; challengeStatus: String; pageIndex: Number, pageSize: Number }) {
        const headers = await authHeader();
        return axios.post(baseUrl + '/api/my-challenges', reqBody, { headers: headers });
    }
